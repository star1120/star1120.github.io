...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getCaseDetial(id) {
            this.activeName = 1;
            let url = this.userInfo.userType == 2 ? __WEBPACK_IMPORTED_MODULE_0__service_path__["a" /* default */].patientGetCaseById : __WEBPACK_IMPORTED_MODULE_0__service_path__["a" /* default */].docGetCaseById;
            this.$api.post(url, {
                id: id
            }, res => {
...
// module
exports.push([module.i, ".prescription_dialog_mask[data-v-7829d3d0]{position:inherit}.prescription_dialog .s_upload_pic .pic_cont[data-v-7829d3d0],.prescription_dialog .s_upload_pic[data-v-7829d3d0]{height:auto}.selectPreion[data-v-7829d3d0]{width:80%;margin:10px}#pages[data-v-7829d3d0]{position:absolute;bottom:0;right:0}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(549)("23992450", content, true, {});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "prescription_dialog prescription_dialog_mask"
  }, [_c('div', [_c('div', {
    ...
    }), _vm._v(" "), _c('span', [_vm._v("g")])]), _vm._v(" "), _vm._m(1, true), _vm._v(" "), _c('i', {
    ...
    return _c('li', {
      ...
      staticClass: "ui-flex-1"
    }), _vm._v(" "), (_vm.userInfo.userType == 1) ? _c('a', {
      staticClass: "ui-w-40",
      attrs: {
        "href": "javascript:;"
      },
      ...
      on: {
        "click": function($event) {
          return _vm.getPreionListData(item.id)
        }
      }
    }, [_vm._v("载入")])])
  ...
  }) : _vm._e()], 1)], 2)], 1)])])] : _vm._e()], 2)])])])]), _vm._v(" "), _c('el-dialog', {
    attrs: {
      "title": "各论",

<template>
    ...
    <div>
      ...
      <el-dialog
        ...
        @close="closePreions"
        append-to-body>
        <div class="ui-flex ui-mgb-20 gelun">
          ...
          <el-input size="mini" class="ui-w-80 ui-mgr-10" value="克"></el-input>
        </div>
          ...
          <div class="gelun_dialog_left_cont" >
            <el-tree :data="classify" node-key="id" :expand-on-click-node="false">
              <span class="custom-tree-node" slot-scope="{ node, data }">
                <span @dblclick="() => change(data)" v-if="!data.show"  class="ui-ellipsis" @click="() => getPreion(data)">{{ data.name }}<i v-if="data.remark" class="fa fa-cog"></i></span>
